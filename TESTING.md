...
- **Materias y unidades:** Hub → Español/Historia/Ciencia/Matemáticas → unidad → tema → herramienta → Hub; Inglés/Salud siguen `Próximamente`; Matemáticas contiene solamente Grados decimales a DMS y no recupera temas matemáticos antiguos.
...
- **Navegación:** en teléfono, exactamente Hub, Repasar, Practicar, Cuenta/Entrar y Más; Practicar debe preceder a Repasar cuando ambas acciones compiten y los disclosures no muestran flechas nativas; verificar bottom sheet a 390×844, safe area, Escape, foco, scroll, ausencia de overflow y Admin condicional. En desktop, verificar grupos directos y ausencia de Más.
