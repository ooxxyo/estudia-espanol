...
export const PUBLIC_ROADMAP = Object.freeze([
  ...
  ['prepare-test', 'Preparar prueba', 'Sesiones de 15, 30 o 60 minutos con preguntas oficiales.', 'testing', 'study'],
  ['weak-practice', 'Practicar débiles', 'Refuerzo con preguntas oficiales existentes.', 'development', 'study'],
  ['flashcards', 'Flashcards inteligentes', 'Marca Lo sé o No lo sé; la repetición avanzada sigue futura.', 'testing', 'study'],
  ...
  ['favorites', 'Favoritos', 'Guarda temas, tarjetas, aportes y eventos de forma privada.', 'testing', 'tools'],
